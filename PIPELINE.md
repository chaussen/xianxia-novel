...
| BOT | 类型 | 优先级 | 职责边界 |
|---|---|---|---|
| 读者BOT | 感性读者 | **最终否决权** | 最后一道审读，可推翻流水线任何结果；只问好不好看 |
...
> 读者BOT是流水线**最后一道审读，和作者一样有权推翻流水线任何阶段的结果**。
> 它不看物理是否正确，不看逻辑是否自洽——只看章节是否好看。
> 读者BOT说"不好看"，前面所有工作都要重来。没有"但是物理对了"这种例外。
...
> 修改后的章节必须重新过读者BOT，确认修改没有破坏整体阅读体验。
...
任务：以读者身份对修改后的章节做五项体验反馈，重点关注修改段落是否造成节奏中断或突兀感。
```
...
| 2026-04 | PIPELINE | 作者反馈修改流程加"零、铁律"、读者BOT复核步骤、步骤重编 |
