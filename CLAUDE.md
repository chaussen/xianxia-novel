...
### 篇幅与节奏（每章必须遵守）
- **目标篇幅：2500—3200中文字符**（含账本余页）。提交前自行估算：纯对话与纯内心段落最容易造成字数虚低，每段对话或推演后必须有实体动作或感官细节跟进。
- **感官在场原则**：任何超过一段的内心推演——无论是物理推导、账本计算，还是对他人的判断——必须有具体的身体状态或环境细节穿插其间。思绪在手上的工具、脚下的地面、鼻腔里的气味中流动，不在虚空中运行。这条规则在无格物原理的过渡章里同样适用。
- **感官素材库（可随取）**：矿道的气温与气味层次；工具的重量、纹理、磨损状态；布条、灵石、疤痕的触感；振动通过岩壁传来的方式；光线的角度与亮暗；身体在劳作后的具体反应（麻木、酸胀、出汗）。这些细节无需服务于情节，只需让读者知道角色在哪里、手里拿着什么。
- **技术与描写的平衡**：物理原理通过可见的现象和身体感受呈现，不直接陈述为机理链条。连续两段以上的原理推导即为失衡。目标读者是普通读者，不是物理爱好者。
